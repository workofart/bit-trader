let investment = {
    ...
    UP_STOP_LIMIT: 0.003, // how much % to decrease before closing an upward trend position
    DOWN_STOP_LIMIT: 0.003, // how much % to increase before entering an long position
  };
