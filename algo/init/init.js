...
const {
        ...
        BB_STD_DEV, LOWER_RSI, UPPER_RSI, CORRELATION_PERIOD, CORRELATION_THRESHOLD, PURGE_LENGTH,
        LOW_RSI_OFFSET, LOW_BB_OFFSET,
    } = require('./parameters'),
    {
        ...
        BEAR_LOSS_START, REPEATED_SELL_MARGIN, UP_STOP_LIMIT,
        DOWN_STOP_LIMIT
...
global.LOW_BB_OFFSET = LOW_BB_OFFSET;
global.LOW_RSI_OFFSET = LOW_RSI_OFFSET;
global.CORRELATION_PERIOD = CORRELATION_PERIOD;
global.CORRELATION_THRESHOLD = CORRELATION_THRESHOLD;
global.PURGE_LENGTH = PURGE_LENGTH;
...
global.DOWN_STOP_LIMIT = DOWN_STOP_LIMIT;
global.UP_STOP_LIMIT = UP_STOP_LIMIT;
